...
import InheritanceReplyCard from './InheritanceReplyCard'
      ...
      <div className="card-wrapper">
        <div className="comment-wrapper">
          <div className="count-wrapper">
            <img src={PlusSVG} />
            <div className="numbers-vote">{comment?.score}</div>
            <img src={MinusSVG} />
          </div>
          <div className="content-wrapper">
            <div className="top-section">
              <div className="top-left-section">
                <img style={{ width: "32px", height: "32px" }} src={comment.user.image.webp} />
                <p className="username">{comment?.user.username}</p>
                {comment.user.username === data.currentUser.username && <div className="current-user-label"><p>you</p></div>}
            ...
            <div className="body-section">
              {highlightedText(comment?.content)}
            </div>
